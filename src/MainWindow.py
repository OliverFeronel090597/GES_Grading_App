...
from layouts.About                     import  AboutDialog
from layouts.NotificationManager       import  NotificationManager
from layouts.Animatedstack             import  AnimatedStack
from layouts.Home                      import  HomeWidget
from layouts.AcademicMasterData        import  AcademicMasterData


from layouts.GetSchoolYear             import get_current_school_year
...
class GES_StudentGrading(QMainWindow):
    ...
    def create_taskbar(self):
        ...
        # CENTER
        self.connected_device = QLabel(f"Current School Year : {get_current_school_year()}")
